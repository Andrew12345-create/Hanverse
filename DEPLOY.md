...
| Variable | Value |
|----------|-------|
| `DATABASE_URL` | `postgresql://neondb_owner:REDACTED@ep-little-brook-airyxne9-pooler.c-4.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require` |
| `PORT` | `3000` |
| `NODE_ENV` | `production` |
